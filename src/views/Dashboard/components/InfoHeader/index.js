...
const InfoHeader = (
    ...
    //If overflow, add ... to the end of the string
    //If is thousands, add comma to the number every 3 digits
    //If more than 10000, add K to the end of the number and remove the last 3 digits
    const filterThousands = (num) => {
        if (num > 10000) {
